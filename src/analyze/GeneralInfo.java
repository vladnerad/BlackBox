...
public class GeneralInfo implements Command {
    ...
    protected int getDiselStartQuant() {
        int counter = 0;
    ...
    protected int getMaxFromColumn(ParameterNumber column) {
...
//        for (Integer[] rawValue : rawValues) {
    ...
    protected String getWholeRecTime() {
...
//        System.out.println(records);
    ...
    protected String getRecordingTime(int millisecX100) {
    ...
    protected double getMaxSpeed(int rpm, double ratio) {
